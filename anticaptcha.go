...
func (c *Captcha) createTaskRecaptcha(websiteURL string, recaptchaKey string) (float64, error) {
...
func (c *Captcha) SendRecaptcha(websiteURL string, recaptchaKey string, timeoutInterval time.Duration) (string, error) {
